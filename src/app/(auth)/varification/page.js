                ...
                <div className=" border-2 py-10 px-5 md:px-14">
                    ...
                    <div className="py-7 flex justify-center items-center">
                        <OtpInput
                            ...
                            renderInput={(props) => (
                                <input
                                    {...props}
                                    className="md:w-8 h-12 bg-transparent border-b-2   text-xl focus:outline-none focus:border-red-500 mx-1"
                                />
                            )}
                        />
                    </div>
                    <Link href="/confirm-password">
                        <button
                            ...
                            className="text-center w-full p-3 font-bold text-xl bg-gradient-to-r from-red-900 to-red-700 text-white rounded-md shadow-lg"
                        >
                            Verify
                        </button>
                    </Link>
